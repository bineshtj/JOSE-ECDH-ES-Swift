...
func aesCbcHmacSha2Encrypt(hash: JWAHash, macKey: Data, plaintext: Data, key: Data, iv: Data, tagLen: Int, aad: Data) throws -> (ciphertext: Data, tag: Data) {
...
func aesCbcHmacSha2Decrypt(hash: JWAHash, macKey: Data, ciphertext: Data, key: Data, iv: Data, tag: Data, aad: Data, authTagLen: Int) throws -> Data {
...
fileprivate func computeTag(_ hash: JWAHash, _ macKey: Data, _ aad: Data, _ iv: Data, _ ciphertext: Data, _ tagLen: Int) -> Data {
    // A || IV || E || AL.
